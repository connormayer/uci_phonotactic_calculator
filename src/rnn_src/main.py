...
if __name__ == "__main__":
    ...
    parser.add_argument("input_file", type=str, help="Path to the input corpus file.")
    parser.add_argument("test_file", type=str, help="Path to test data file")
    parser.add_argument(
        "judgement_file", type=str, help="Path to output file with word judgements"
    )
    parser.add_argument(
        "feature_file",
        type=str,
    ...
    parser.add_argument(
        "--batch_size", type=int, help="Batch size.", default=DEFAULT_BATCH_SIZE
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
    ...
    parser.add_argument(
        "--tied",
        default=DEFAULT_TIED,
        help="Whether to use tied embeddings.",
        action="store_true",
    )
    parser.add_argument(
        "--training_split",
        type=int,
        default=DEFAULT_TRAINING_SPLIT,

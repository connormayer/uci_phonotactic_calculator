...
def run_calculator(train_file, test_file, output_file):
    ...
    model_configs = [
        ...
        {"name": "uni_joint_nonpos_smoothed", "model": "unigram", "position": "non_positional", "joint": True, "smoothed": False, "token_weighted": False},
        ...
        # Unigram positional (joint) - Sum and Prod versions
        {"name": "uni_joint_pos", "model": "unigram", "position": "positional", "joint": True, "smoothed": False, "token_weighted": False, "aggregation": "sum"},
        {"name": "uni_joint_pos_prod", "model": "unigram", "position": "positional", "joint": True, "smoothed": False, "token_weighted": False, "aggregation": "prod"},
        {"name": "uni_joint_pos_freq_weighted", "model": "unigram", "position": "positional", "joint": True, "smoothed": False, "token_weighted": True, "aggregation": "sum"},
        {"name": "uni_joint_pos_freq_weighted_prod", "model": "unigram", "position": "positional", "joint": True, "smoothed": False, "token_weighted": True, "aggregation": "prod"},
        {"name": "uni_joint_pos_smoothed", "model": "unigram", "position": "positional", "joint": True, "smoothed": True, "token_weighted": False, "aggregation": "sum"},
        {"name": "uni_joint_pos_smoothed_prod", "model": "unigram", "position": "positional", "joint": True, "smoothed": True, "token_weighted": False, "aggregation": "prod"},
        {"name": "uni_joint_pos_freq_weighted_smoothed", "model": "unigram", "position": "positional", "joint": True, "smoothed": True, "token_weighted": True, "aggregation": "sum"},
        {"name": "uni_joint_pos_freq_weighted_smoothed_prod", "model": "unigram", "position": "positional", "joint": True, "smoothed": True, "token_weighted": True, "aggregation": "prod"},
            
        # Bigram conditional, positional with word boundaries - Sum and Prod versions
        {"name": "bi_cond_pos_wb", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": True, "smoothed": False, "token_weighted": False, "aggregation": "sum"},
        {"name": "bi_cond_pos_wb_prod", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": True, "smoothed": False, "token_weighted": False, "aggregation": "prod"},
        {"name": "bi_cond_pos_wb_freq_weighted", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": True, "smoothed": False, "token_weighted": True, "aggregation": "sum"},
        {"name": "bi_cond_pos_wb_freq_weighted_prod", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": True, "smoothed": False, "token_weighted": True, "aggregation": "prod"},
        {"name": "bi_cond_pos_wb_smoothed", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": True, "smoothed": True, "token_weighted": False, "aggregation": "sum"},
        {"name": "bi_cond_pos_wb_smoothed_prod", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": True, "smoothed": True, "token_weighted": False, "aggregation": "prod"},
        {"name": "bi_cond_pos_wb_freq_weighted_smoothed", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": True, "smoothed": True, "token_weighted": True, "aggregation": "sum"},
        {"name": "bi_cond_pos_wb_freq_weighted_smoothed_prod", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": True, "smoothed": True, "token_weighted": True, "aggregation": "prod"},
            
        # Bigram conditional, positional without word boundaries - Sum and Prod versions
        {"name": "bi_cond_pos_noWB", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": False, "smoothed": False, "token_weighted": False, "aggregation": "sum"},
        {"name": "bi_cond_pos_noWB_prod", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": False, "smoothed": False, "token_weighted": False, "aggregation": "prod"},
        {"name": "bi_cond_pos_noWB_freq_weighted", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": False, "smoothed": False, "token_weighted": True, "aggregation": "sum"},
        {"name": "bi_cond_pos_noWB_freq_weighted_prod", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": False, "smoothed": False, "token_weighted": True, "aggregation": "prod"},
        {"name": "bi_cond_pos_noWB_smoothed", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": False, "smoothed": True, "token_weighted": False, "aggregation": "sum"},
        {"name": "bi_cond_pos_noWB_smoothed_prod", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": False, "smoothed": True, "token_weighted": False, "aggregation": "prod"},
        {"name": "bi_cond_pos_noWB_freq_weighted_smoothed", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": False, "smoothed": True, "token_weighted": True, "aggregation": "sum"},
        {"name": "bi_cond_pos_noWB_freq_weighted_smoothed_prod", "model": "bigram", "position": "positional", "conditional": True, "use_boundaries": False, "smoothed": True, "token_weighted": True, "aggregation": "prod"},
            
        # Bigram conditional, non-positional with word boundaries (unchanged)
        ...
        # Bigram conditional, non-positional without word boundaries (unchanged)
        ...
        # Bigram joint, positional with word boundaries - Sum and Prod versions
        {"name": "bi_joint_pos_wb", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": True, "smoothed": False, "token_weighted": False, "aggregation": "sum"},
        {"name": "bi_joint_pos_wb_prod", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": True, "smoothed": False, "token_weighted": False, "aggregation": "prod"},
        {"name": "bi_joint_pos_wb_freq_weighted", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": True, "smoothed": False, "token_weighted": True, "aggregation": "sum"},
        {"name": "bi_joint_pos_wb_freq_weighted_prod", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": True, "smoothed": False, "token_weighted": True, "aggregation": "prod"},
        {"name": "bi_joint_pos_wb_smoothed", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": True, "smoothed": True, "token_weighted": False, "aggregation": "sum"},
        {"name": "bi_joint_pos_wb_smoothed_prod", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": True, "smoothed": True, "token_weighted": False, "aggregation": "prod"},
        {"name": "bi_joint_pos_wb_freq_weighted_smoothed", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": True, "smoothed": True, "token_weighted": True, "aggregation": "sum"},
        {"name": "bi_joint_pos_wb_freq_weighted_smoothed_prod", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": True, "smoothed": True, "token_weighted": True, "aggregation": "prod"},
            
        # Bigram joint, positional without word boundaries - Sum and Prod versions
        {"name": "bi_joint_pos_noWB", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": False, "smoothed": False, "token_weighted": False, "aggregation": "sum"},
        {"name": "bi_joint_pos_noWB_prod", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": False, "smoothed": False, "token_weighted": False, "aggregation": "prod"},
        {"name": "bi_joint_pos_noWB_freq_weighted", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": False, "smoothed": False, "token_weighted": True, "aggregation": "sum"},
        {"name": "bi_joint_pos_noWB_freq_weighted_prod", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": False, "smoothed": False, "token_weighted": True, "aggregation": "prod"},
        {"name": "bi_joint_pos_noWB_smoothed", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": False, "smoothed": True, "token_weighted": False, "aggregation": "sum"},
        {"name": "bi_joint_pos_noWB_smoothed_prod", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": False, "smoothed": True, "token_weighted": False, "aggregation": "prod"},
        {"name": "bi_joint_pos_noWB_freq_weighted_smoothed", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": False, "smoothed": True, "token_weighted": True, "aggregation": "sum"},
        {"name": "bi_joint_pos_noWB_freq_weighted_smoothed_prod", "model": "bigram", "position": "positional", "conditional": False, "use_boundaries": False, "smoothed": True, "token_weighted": True, "aggregation": "prod"},
            
        # Bigram joint, non-positional with word boundaries (unchanged)
        ...
        # Bigram joint, non-positional without word boundaries (unchanged)
